...
export const requests = [
    ...
    },
    {
        ...
        status: 'new',
        isRead: true,
        patientName: 'Thom Brown',
        requestDate: '2025-06-05T00:00:00.000Z',
        lastModifiedDate: '2025-06-05T16:31:30.000Z',
        description: '[06/05/25] ref; [05/26/25] Sanity refill; [05/22/25] i need a refill ASAP',
    ...
    },
    {
        ...
        lastModifiedDate: '2025-05-20T10:15:30.000Z',
        description: '[05/20/25] Metformin 500mg refill request',
        estimatedTimeSec: 120,
        assignment: {
            assignDate: '2025-05-20T10:15:30.000Z',
            assignedTo: 'Dr. Johnson',
            grouping: 'DEFAULT_GROUPING',
        },
        isUrgent: false,
        prescriptionIds: ['rx-12345'],
        recommendation: {
            recommendationValue: 'yes',
            recommendationDescription: 'Recommend approval based on patient history.',
        },
    },
    {
        type: 'labReport',
        ...
        lastModifiedDate: '2025-05-19T16:22:45.000Z',
        description: '3 lab reports',
        estimatedTimeSec: 90,
        assignment: {
            assignDate: '2025-05-19T16:22:45.000Z',
            assignedTo: 'Dr. Johnson',
            grouping: 'DEFAULT_GROUPING',
        },
        isUrgent: false,
        abnormalResults: ['High glucose'],
        panels: ['Lipid Panel', 'Metabolic Panel', 'CBC'],
    },
    {
        type: 'freeText',
        id: '13',
        ...
        lastModifiedDate: '2025-05-18T09:30:00.000Z',
        description: '[05/18/25] Question about medication side effects',
        estimatedTimeSec: 180,
        assignment: {
            assignDate: '2025-05-18T09:30:00.000Z',
            assignedTo: 'Dr. Johnson',
        },
        isUrgent: false,
        labels: ['Rx', 'Clinical'],
    },
    {
        ...
        lastModifiedDate: '2025-05-17T14:45:00.000Z',
        description: '[05/17/25] Lisinopril 10mg renewal',
        estimatedTimeSec: 95,
        assignment: {
            assignDate: '2025-05-17T14:45:00.000Z',
            assignedTo: 'Dr. Johnson',
            grouping: 'DEFAULT_GROUPING',
        },
        isUrgent: true,
        prescriptionIds: ['rx-67890'],
        recommendation: {
            recommendationValue: 'yes',
            recommendationDescription: 'Blood pressure stable. Recommend renewal.',
        },
    },
    {
        type: 'labReport',
        ...
        lastModifiedDate: '2025-05-16T11:00:00.000Z',
        description: '1 lab report',
        estimatedTimeSec: 45,
        assignment: {
            assignDate: '2025-05-16T11:00:00.000Z',
            assignedTo: 'Dr. Johnson',
            grouping: 'DEFAULT_GROUPING',
        },
        isUrgent: false,
